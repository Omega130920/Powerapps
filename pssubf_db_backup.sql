...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$1000000$5TT8Ai0Ecn0NnvZ9aks6JG$80TqknYKS17rpOmhKKKl2u2Ga9haAbGN+/Dbyw4lcLQ=','2026-01-28 08:19:05.866608',1,'omega','','','',1,1,'2026-01-06 10:01:53.589111');
...
--
-- Table structure for table `pssubf_notes`
--

DROP TABLE IF EXISTS `pssubf_notes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pssubf_notes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `task_email_id` varchar(255) NOT NULL,
  `agent_name` varchar(100) NOT NULL,
  `note_text` text NOT NULL,
  `classification_at_time` varchar(100) DEFAULT NULL,
  `status_at_time` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `pssubf_notes`
--

LOCK TABLES `pssubf_notes` WRITE;
/*!40000 ALTER TABLE `pssubf_notes` DISABLE KEYS */;
INSERT INTO `pssubf_notes` VALUES (1,'AAMkAGZjYjdiOTRmLTE2NzUtNGZjOC05ZGFjLTg2ZDg5Njg5MWM0YgBGAAAAAADEJ2EtNBRaTZb8IbsozU7UBwBu-DXBqCMVSZfmbt_zDCT1AAAAAAEMAABu-DXBqCMVSZfmbt_zDCT1AAAYsUfNAAA=','omega','Hope this works','Overdue Payment - Monthly Income','In Progress','2026-01-28 08:17:07');
/*!40000 ALTER TABLE `pssubf_notes` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pssubf_outlook_token` VALUES (1,'testuser@futurasa.co.za','eyJ0eXAiOiJKV1QiLCJub25jZSI6IjZYdDVGN2hraDV5NFBuTDFrWHBpYnJhRVFfaXgwN3Jxd21OQS1LcmwzWFUiLCJhbGciOiJSUzI1NiIsIng1dCI6IlBjWDk4R1g0MjBUMVg2c0JEa3poUW1xZ3dNVSIsImtpZCI6IlBjWDk4R1g0MjBUMVg2c0JEa3poUW1xZ3dNVSJ9..CceyP8XidzEyUDfVlGqcmJMbsPtMED7rL62H20oMvXahADi3rMF-wDWry06NPbP84mJv0vtv2W5Do_pkZVchlaXjKW-NtaNg7z8el0Kb5E0A2XaP5BEACWyWxVZBjttmIyMyaaxP3-5oDmPM8QvVLzyw-Fb20FgnPdNkGNK6WyLaslUn9oWy8tj5i64um8uQuPPnLU_UZVAUTdFnI70ud7FaCRR-Wk2zS9sPtF9qn1yOOmRDdtU14fSO8KZLnn6tODsnuTIZneSeYyBhhtAKnw7oPxyeYdFjWmqmOGv-neS7YT1p6aTQ-CgdP7XV9gt2GvdKRX3GVE5pbOmWCQMxFA','2026-01-28 11:16:48');
...
-- Dump completed on 2026-01-30 10:14:58
