...
urlpatterns = [
    ...
    path('unity-billing/edit/<str:company_code>/<int:bill_id>/', views.edit_bill, name='edit_bill'),
    path('pre-bill/summary/<str:company_code>/<int:bill_id>/', views.pre_bill_reconciliation_summary, name='pre_bill_reconciliation_summary'),
    path('pre-bill/process-cash/<str:company_code>/<int:bill_id>/', views.process_cash_allocation, name='process_cash_allocation'),
    path('unity/reconcile-bill/<str:company_code>/<int:bill_id>/', views.finalize_reconciliation, name='finalize_reconciliation'),
    path('pre-bill/process/<str:company_code>/<int:bill_id>/', views.process_bill_settlement, name='process_bill_settlement'),
    path('admin-billing/', views.admin_billing_view, name='admin_billing'),

    # Credit Notes & Surplus
